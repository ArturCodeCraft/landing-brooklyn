...
function windowLoad() {
	...
	const swiperBlog = new Swiper('.swiper-blog', {
		...
		// Automatic scrolling settings
		autoplay: {
			delay: 3000, // delay between slides (in milliseconds)
			disableOnInteraction: false, // continue automatic scrolling after user interaction
		},
		...
		pagination: {
			...
			bulletClass: 'swiper-blog__bullet',
	...
	const swiperTestimonial = new Swiper('.swiper-testimonial', {
		// Optional parameters
		slidesPerView: 1, // if `auto`, then shows the automatic number of slides
		loop: true, // if `true` then continuous scrolling
		...
		wrapperClass: 'swiper-testimonial__wrapper',
		slideClass: 'swiper-testimonial__slide',
		slideActiveClass: '_slide-active',
		...
		pagination: {
			...
			bulletClass: 'swiper-testimonial__bullet',
			bulletActiveClass: '_bullet-active',
